...
namespace AccessLens.Core.Audit;
...
public sealed record RequestRecord
{
    ...
    /// <summary>Exchange/Purview: the AL- role group created to carry this grant.</summary>
    public string? ExoRoleGroup { get; init; }
    /// <summary>Exchange/Purview: the management role assigned (custom AL- role or built-in).</summary>
