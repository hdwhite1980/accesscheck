...
public sealed record AssignmentPlan
{
    ...
    /// <summary>
    /// When true the grant never expires: PIM receives expiration type "noExpiration"
    /// and Duration is ignored. The tenant's PIM role policy can still reject a
    /// permanent assignment if it enforces a maximum duration.
    /// </summary>
